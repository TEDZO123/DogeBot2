...
const starts = async (dogexeon = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('𝚃𝙴𝙳𝚉𝙾 Bot', {
		font: 'Standard',
...
console.log(color('  Xeon Bot Inc. 2021','mediumseagreen'))
	dogexeon.browserDescription = [ '𝚃𝙴𝙳𝚉𝙾𝚂𝙸𝚁', 'ubuntu', '3.0' ]
